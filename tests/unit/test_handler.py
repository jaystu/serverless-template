...
lambda_function_dir_2 = os.path.abspath('/serverless-template/')
sys.path.append(lambda_function_dir_2)
lambda_function_dir_3 = os.path.abspath('./serverless-template/')
sys.path.append(lambda_function_dir_3)
sys.path.append('...')
sys.path.append('..')
sys.path.append('.')
print("PYTHONPATH")
